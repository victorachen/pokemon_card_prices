...
WATCHLIST = [
    ...
    {
        "label":    "Charizard Crystal Guardians (Holo)",
        "language": "English",
        "raw_q":    "Charizard Crystal Guardians holo -reverse -PSA -BGS -SGC -CGC -lot -proxy -japanese -keychain -pin",
        "graded_q": "Charizard Crystal Guardians -reverse -japanese -keychain -pin -lot -proxy",
        "required_in_title": ["charizard", "crystal"],
        "tcg_name": "Charizard", "tcg_set": "ex14", "tcg_rev": False,
    },
    {
        ...
        "graded_q": "Gyarados Holon Phantoms reverse -japanese -keychain -pin -lot -proxy",
        "required_in_title": ["gyarados", "holon"],
        "tcg_name": "Gyarados", "tcg_set": "ex13", "tcg_rev": True,
    },
    {
        "label":    "Gyarados Holon Phantoms (Holo)",
        "language": "English",
        "raw_q":    "Gyarados Holon Phantoms holo -reverse -PSA -BGS -SGC -CGC -lot -proxy -japanese -keychain -pin",
        "graded_q": "Gyarados Holon Phantoms -reverse -japanese -keychain -pin -lot -proxy",
        "required_in_title": ["gyarados", "holon"],
        "tcg_name": "Gyarados", "tcg_set": "ex13", "tcg_rev": False,
    },
    {
    ...
    {
        "label":    "Dragonite Delta Species (Holo)",
        "language": "English",
        "raw_q":    "Dragonite Delta Species holo -reverse -PSA -BGS -SGC -CGC -lot -proxy -japanese -keychain -pin",
        "graded_q": "Dragonite Delta Species -reverse -japanese -keychain -pin -lot -proxy",
        "required_in_title": ["dragonite", "delta"],
        "tcg_name": "Dragonite", "tcg_set": "ex11", "tcg_rev": False,
    },
    {
